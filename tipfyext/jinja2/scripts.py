...
def compile_templates(argv=None):
    ...
    app_path = argv[1] if len(argv) > 1 else 'app'

    base_path = os.getcwd()
    app_path = os.path.join(base_path, app_path)
    ...
    template_path = app.config['tipfyext.jinja2']['templates_dir']
    compiled_path = app.config['tipfyext.jinja2']['templates_compiled_target']
