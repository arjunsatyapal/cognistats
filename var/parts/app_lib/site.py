...
def addsitepackages(known_paths):
    ...
    base = os.path.dirname(base)
    base = os.path.dirname(base)
    setuptools_path = '/System/Library/Frameworks/Python.framework/Versions/2.6/Extras/lib/python'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        join(base, 'eggs/tipfy-1.0b1-py2.6.egg'),
        join(base, 'eggs/Jinja2-2.5.5-py2.6.egg'),
        join(base, 'eggs/Babel-0.9.6-py2.6.egg'),
        join(base, 'eggs/gaepytz-2011c-py2.6.egg'),
        join(base, 'eggs/WTForms-0.6.3-py2.6.egg'),
        '/System/Library/Frameworks/Python.framework/Versions/2.6/Extras/lib/python',
        join(base, 'eggs/blinker-1.1-py2.6.egg'),
        join(base, 'eggs/Werkzeug-0.6.2-py2.6.egg')
        ]
