...
public class TestSelectorView extends View implements TestSelectorDisplay {
  ...
  @UiField
  Button buttonDigitSpan;
  @UiField
  Button buttonSpatialSpan;
  ...
  @Override
  public Button getButtonArjunGrid() {
    return buttonArjunGrid;
  }

  @Override
  public Button getButtonDigitSpan() {
	  return buttonDigitSpan;
  }

  @Override
  public Button getButtonSpatialSpan() {
	  return buttonSpatialSpan;
  }
