...
public class BaseTestStatisticsView extends Composite implements
  ...
  protected String zeroPadding(
    long number, int padding) {
  ...
  protected String formatTime(
    long timeInMillis, boolean withMillis) {
    ...
    String s =
      Long.toString(hours) + ":" + zeroPadding(minutes, 2) + ":"
  ...
  @Override
  public void setTestTimeCurrent(
    long timeInMillis) {
    labelTimeCurrentSession.setText(formatTime(timeInMillis, true));
  }

  @Override
  public void setTestTimeAllTime(
    long timeInMillis) {
